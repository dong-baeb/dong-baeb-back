...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        notificationRepository.save(new Notification("안녕","단녕",member, University.KONKUK,false));
        ...
        for(int i=0; i<50;i++) {
            if(i%5==0) {
                notificationRepository.save(new Notification("공지에요"+String.valueOf(i),"이것은 공지입니다.",member,University.SIRIB,false));
            }
            else {
                notificationRepository.save(new Notification("공지에요"+String.valueOf(i),"이것은 공지입니다.",member,null,true));
            }
        }
    }
}
